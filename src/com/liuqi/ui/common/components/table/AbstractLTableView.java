 ...
 * @param <T> 表格中存储的对象类型
 */
public abstract class AbstractLTableView<T> extends TableView<T> {
    public AbstractLTableView() {
     ...
     * 添加CheckBox类型的列
     */
    public AbstractLTableView<T> addCheckBoxColumn(String title, String property) {
        //添加列属性名称
     ...
     * 添加下拉的列
     */
    public <R> AbstractLTableView<T> addComboBoxColumn(String title, String property,
                                                       List<R> itemList) {
     ...
     * 增加表格列
     */
    public <S> AbstractLTableView<T> addTableColumn(String title, String property,
                                                    Callback<Void, AbstractLTableView<S>> callback,
                                                    double...width) {
        TableColumn<T, AbstractLTableView<S>> column = new TableColumn<>(title);
        column.setCellValueFactory(param -> {
            List<S> list = ReflectUtil.getBeanValue(param.getValue(), property);
            AbstractLTableView<S> tableView = callback.call(null);
     ...
     * 添加文本列
     */
    public AbstractLTableView<T> addColumn(String title, String property, double...width) {
     ...
     * 添加对象列
     */
    public <I> AbstractLTableView<T> addObjectColumn(String title, String property, StringConverter<I> convert, double...width) {
