 ...
 * @version V1.0
 **/
public class ConfigEntityTreeTablePanel extends AbstractEntityTreeTablePanel {
    private PanelConfig panelConfig;

    public static ConfigEntityTreeTablePanel getInstance(PanelConfig panelConfig) {
        return new ConfigEntityTreeTablePanel(panelConfig);
    }
    ...
    public void initToolBar(ToolBar toolBar) {
        ...
        comboBoxList.forEach(comboBox -> {
            ...
            ConfigEntityTreeTablePanel.this.getToolBar().getItems().add(comboBox);
